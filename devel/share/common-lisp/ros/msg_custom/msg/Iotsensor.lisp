...
(cl:defmethod cl:initialize-instance :after ((m <Iotsensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Iotsensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_custom-msg:<Iotsensor> is deprecated: use msg_custom-msg:Iotsensor instead.")))
