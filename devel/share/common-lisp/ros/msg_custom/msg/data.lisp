...
(cl:defmethod cl:initialize-instance :after ((m <data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_custom-msg:<data> is deprecated: use msg_custom-msg:data instead.")))
...
(cl:defmethod temperature-val ((m <data>))
...
(cl:defmethod humidity-val ((m <data>))
